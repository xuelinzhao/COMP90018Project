...
//        let photo4 = UIImage(named: "defaultPhoto")
        ...
        guard let contact1 = Contact(name: "Emergency Numebr", photo: photo1, phoneNumber: "000") else {
            fatalError("Unable to instantiate contact1")
        }
        
        guard let contact2 = Contact(name: "Home", photo: photo2, phoneNumber: "987654321") else {
